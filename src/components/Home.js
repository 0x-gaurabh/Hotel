  ...
  return (
    <>
      <div className="header">
        <div className="header-content absolute flex flex-col items-center   bottom-60 left-2/4 ">
          <h1 className="text-6xl font-bold font-serif"> Welcome To Suites</h1>
          <p className="text-sm font-semibold pt-5 ">HOTEL & RESORT</p>
        </div>
      </div>
      <div className=" ">
